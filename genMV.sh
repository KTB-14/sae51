...
# Ajouter dans le script la gestion d'arguments. Le script devra prendre des arguments (1 ou 2, selon le cas). 

# Le premier argument a donner sera une lettre, décrivant l'action souhaitée :
...
# Le 2e argument sera le nom de la machine concernée, pour les commandes N, S, D, A.
# Les machines créées auront les mêmes caractéristiques que précédemment. 
# La taille de la RAM et du DD seront données en tête du script via des variables, de façon à être
# facilement modifiable.
# Par exemple :
#   RAM=4096 

# DEBUT SCRIPT ETAPE 1,2,3,4 ---------------------------------------------------------------
